...
const CreateUser = () => {
    ...
    useEffect(() => {
        const fetchInitData = async () => {
            ...
            try {
                ...
                console.error("Error cargando datos de inicialización:", err);
                setModalConfig({
                    isOpen: true,
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await UserService.saveOrUpdate(formData);
            setModalConfig({
                isOpen: true,
            ...
            setModalConfig({
                ...
                message: 'Ocurrió un problema al intentar registrar al usuario. Por favor verifique los datos.',
                type: 'error'
            });
        } finally {
            setSubmitting(false);
    ...
    return (
        <div className="w-full max-w-4xl mx-auto mt-2 font-nunito font-medium px-4 md:px-0">
            <StatusModal
